...
require (
	github.com/IBM/ibmcloud-volume-interface v1.0.1-0.20220211044914-b92661774dc9
	github.com/IBM/ibmcloud-volume-vpc v1.0.0-beta9.0.20220211051306-1f9167c3340f
