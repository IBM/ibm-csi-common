...
require (
	github.com/IBM/ibmcloud-volume-interface v1.0.1-0.20220216034035-8b8dc4ab8a5d
	github.com/IBM/ibmcloud-volume-vpc v1.0.0-beta9.0.20220216034949-28037d0beae6
